...
Pod::Spec.new do |s|
  ...
  s.author             = { "Sushant Jagtap" => "sushantjagtap9945@gmail.com" }
  # Or just: s.author    = "Sushant Jagtap"
  # s.authors            = { "Sushant Jagtap" => "sushantjagtap9945@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Sushant Jagtap"
  ...
  s.source_files  = "NetStatus/Source/*.{swift}"
  s.swift_version = "4.0"
